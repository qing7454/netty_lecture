...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2018-03-03")
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField MARRED_FIELD_DESC = new org.apache.thrift.protocol.TField("marred", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean marred; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    USERNAME((short)1, "username"),
    AGE((short)2, "age"),
    MARRED((short)3, "marred");
  ...
  private static final int __MARRED_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USERNAME,_Fields.AGE,_Fields.MARRED};
  ...
  static {
    ...
    tmpMap.put(_Fields.MARRED, new org.apache.thrift.meta_data.FieldMetaData("marred", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public Person setMarred(boolean marred) {
    this.marred = marred;
    setMarredIsSet(true);
    return this;
  }

  public void unsetMarred() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MARRED_ISSET_ID);
  }

  /** Returns true if field marred is set (has been assigned a value) and false otherwise */
  public boolean isSetMarred() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MARRED_ISSET_ID);
  }

  public void setMarredIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MARRED_ISSET_ID, value);
  }
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_marred = true && this.isSetMarred();
    boolean that_present_marred = true && that.isSetMarred();
    if (this_present_marred || that_present_marred) {
      if (!(this_present_marred && that_present_marred))
        return false;
      if (this.marred != that.marred)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMarred()) ? 131071 : 524287);
    if (isSetMarred())
      hashCode = hashCode * 8191 + ((marred) ? 131071 : 524287);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.valueOf(isSetMarred()).compareTo(other.isSetMarred());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMarred()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.marred, other.marred);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // MARRED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.marred = iprot.readBool();
              struct.setMarredIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMarred()) {
        oprot.writeFieldBegin(MARRED_FIELD_DESC);
        oprot.writeBool(struct.marred);
        oprot.writeFieldEnd();
      }
